...
@TeleOp(name="Goodies_tank", group="Drive")

public class Mecanum_tank extends OpMode {
    ...
    public void loop() {
        ...
        top_left.setPower(left);
        top_right.setPower(right);
        bottom_left.setPower(left);
        bottom_right.setPower(right);
