...
@Autonomous(name="AUTONOMOUS_P_ALL2", group="AUTON")
public class Auton4 extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        top_left.setTargetPosition(robot.inch_per_enc(-24));
        top_right.setTargetPosition(robot.inch_per_enc(24));
        bottom_left.setTargetPosition(robot.inch_per_enc(24));
        bottom_right.setTargetPosition(robot.inch_per_enc(-24));
